...
comment = " LR_ACTOR=1e-2 LR_CRITIC = 1e-4 sigma=0.15 [400, 300]"
...
class Agent():
    ...
    def learn(self, experiences, gamma):
        ...
        self.writer.add_scalar("Critic_loss", critic_loss, self.train_epochs)
        ...
        self.writer.add_scalar("Actor_loss", actor_loss, self.train_epochs)
